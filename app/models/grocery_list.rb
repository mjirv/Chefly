class GroceryList < ApplicationRecord
    ...
    def deduplicate
        ...
        while glis.length != 0
            ...
            # Add the merged GLI
            new_merged_gli = GroceryListItem.create(:name => gli.name, :amount => new_amount, :grocery_list_id => self.id, :recipe_item_id => gli.recipe_item_id, :visible => true, :combined => true, :user_edited => false)
