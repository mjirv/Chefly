class GroceryList < ApplicationRecord
    ...
    def deduplicate
        ...
        while glis.length != 0
            ...
            # Add the merged GLI
            new_merged_gli = GroceryListItem.new(:name => gli.name, :amount => new_amount, :grocery_list_id => gli.id, :recipe_item_id => gli.recipe_item_id, :item_name => gli.item_name, :visible => true, :combined => true, :user_edited => false)
